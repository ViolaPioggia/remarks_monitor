...
import (
	...
	"remarks_monitor/app/usercenter/cmd/rpc/internal/server"
...
var configFile = flag.String("f", "C:/Users/ViolaPioggia/GolandProjects/1remarks_monitor/app/usercenter/cmd/rpc/etc/usercenter.yaml", "the config file")
